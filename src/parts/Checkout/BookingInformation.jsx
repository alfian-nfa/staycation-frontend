        ...
        <div className="col-12 col-lg-5 border-right p-5 pr-lg-5">
          <div className="card">
            <figure className="img-wrapper" style={{ height: 270 }}>
              <img className="img-cover" src={`${process.env.REACT_APP_HOST}/${ItemDetails.item.imageId[0].imageUrl}`} alt={ItemDetails.item.title} />
            </figure>
              ...
              <div className="col">
                <div className="meta-wrapper">
                  ...
                  <span className="text-gray-500">
                    {ItemDetails.item.city}, {ItemDetails.item.country}
                  </span>
                </div>
              </div>
              <div className="col-auto">
                <span>
                  ${+checkout.duration * ItemDetails.item.price} USD
                  <span className="text-gray-500"> per </span>
                  {checkout.duration} {ItemDetails.item.unit}
